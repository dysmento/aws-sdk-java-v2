...
public class AsyncClientInterface implements ClassSpec {
    ...
    private BuilderModelBag operationMethod(OperationModel opModel) {
        ...
        streamingMethod(methodBuilder, opModel, responsePojoType);

        return new BuilderModelBag(methodBuilder, opModel, false);
    }
    ...
    private void streamingMethod(MethodSpec.Builder builder, OperationModel opModel, ClassName responsePojoType) {
